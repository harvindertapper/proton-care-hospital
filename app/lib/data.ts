...
export const doctors: Doctor[] = [
  { slug: "dr-ramesh", name: "DR. RAMESH CHANDRA", speciality: "General Physician", qualification: "MBBS", departmentSlug: "general-medicine", photo: "/assets/doctors/dr-ramesh.webp" },
  ...
  { slug: "dr-sanjeev-thakral", name: "DR. SANJEEV THAKRAL", speciality: "Internal Medicine Specialist", qualification: "MBBS, MD (Medicine)", departmentSlug: "general-medicine" },
  { slug: "dr-mohit-saran", name: "DR. MOHIT SARAN", speciality: "Internal Medicine Specialist", qualification: "MBBS, MD (Medicine)", departmentSlug: "general-medicine" },
  { slug: "dr-rajeev", name: "DR. RAJEEV KUMAR", speciality: "General Physician", departmentSlug: "general-medicine", photo: "/assets/doctors/dr-rajeev.webp" },
  { slug: "dr-devender", name: "DR. DEVENDER SINGH", speciality: "General Physician", departmentSlug: "general-medicine", photo: "/assets/doctors/dr-devender.webp" },
  { slug: "dr-chanderkanta-arya", name: "DR. CHANDERKANTA ARYA", speciality: "Obstetrician & Gynaecologist", qualification: "MBBS, DGO", departmentSlug: "obstetrics-and-gynecology", photo: "/assets/doctors/dr-chanderkanta-arya.webp" },
  { slug: "dr-jaidev", name: "DR. JAIDEV SHARMA", speciality: "Nephrologist", qualification: "MBBS, MD (Medicine), DM (Nephrology)", departmentSlug: "general-medicine" },
  { slug: "dr-rukma", name: "DR. RUKMA SINGH", speciality: "Neurologist", qualification: "MBBS, MD (Medicine), DM (Neurology)", departmentSlug: "neurology", photo: "/assets/doctors/dr-rukma.webp" },
  { slug: "dr-rohit-arora", name: "DR. ROHIT ARORA", speciality: "Orthopaedic Surgeon", qualification: "MBBS, MS (Orthopaedics), M.Ch", departmentSlug: "orthopaedic-surgery" },
  { slug: "dr-anurag-singh-thakur", name: "DR. ANURAG SINGH THAKUR", speciality: "Paediatrician", qualification: "MBBS, MD (Paediatrics)", departmentSlug: "paediatrics" },
  { slug: "dr-ankur-popat", name: "DR. ANKUR POPAT", speciality: "General Surgeon", qualification: "MBBS, MS (General Surgery)", departmentSlug: "general-surgery", photo: "/assets/doctors/dr-ankur-popat.webp" },
  { slug: "dr-ashwani-yadav", name: "DR. ASHWANI YADAV", speciality: "Critical Care Specialist", qualification: "MBBS, MD (Anaesthesiology)", departmentSlug: "general-medicine" },
  { slug: "dr-vikas-tiwadi", name: "DR. VIKAS TIWADI", speciality: "Critical Care Specialist", qualification: "MBBS, MD (Anaesthesiology)", departmentSlug: "general-medicine" },
  { slug: "dr-pankaj-mittal", name: "Dr Pankaj Mittal", speciality: "General Physician", qualification: "MBBS, MD (Medicine)", departmentSlug: "general-medicine" },
  { slug: "dr-vikram-dagar", name: "Dr Vikram Dagar", speciality: "Orthopaedic Surgeon", qualification: "MBBS, MS (Orthopaedics)", departmentSlug: "orthopaedic-surgery" },
  { slug: "dr-sonam", name: "Dr Sonam", speciality: "Obstetrician & Gynaecologist", qualification: "MBBS, MS (Obstetrics & Gynaecology)", departmentSlug: "obstetrics-and-gynecology" },
  { slug: "dr-rajesh-kumar-rathi", name: "Dr Rajesh Kumar Rathi", speciality: "Paediatrician", qualification: "MBBS, MD (Paediatrics)", departmentSlug: "paediatrics" },
  { slug: "dr-vikas-tiwari", name: "Dr Vikas Tiwari", speciality: "Anaesthesiologist", qualification: "MBBS, MD (Anaesthesiology)", departmentSlug: "anaesthesiology" },
  { slug: "dr-sahil-kapoor", name: "DR. SAHIL KAPOOR", speciality: "ENT Specialist", qualification: "MBBS, MS (ENT)", departmentSlug: "ent", photo: "/assets/doctors/dr-sahil-kapoor.webp" },
  { slug: "dr-apurva-nagesh-sharma", name: "DR. APURVA NAGESH SHARMA", speciality: "Neurologist", qualification: "MBBS, MD (Medicine), DM (Neurology)", departmentSlug: "neurology" },
  { slug: "dr-uddhavesh-mukund-paithankar", name: "DR. UDDHAVESH MUKUND PAITHANKAR", speciality: "Gastroenterologist", qualification: "MBBS, MD (Medicine), DM (Gastroenterology)", departmentSlug: "medical-gastroenterology", photo: "/assets/doctors/dr-uddhavesh-mukund-paithankar.webp" },
  { slug: "dr-praveen-kumar-yadav", name: "DR. PRAVEEN KUMAR YADAV", speciality: "Urologist", qualification: "MBBS, MS (General Surgery), M.Ch (Urology)", departmentSlug: "urology", photo: "/assets/doctors/dr-praveen-kumar-yadav.webp" },
  { slug: "dr-pritam", name: "DR. PRITAM", speciality: "Dentist", qualification: "MDS", departmentSlug: "dental" },
  { slug: "dr-manish-kumar", name: "Manish Kumar", speciality: "Physiotherapist (BPT)", qualification: "BPT", departmentSlug: "physiotherapy" },
];
