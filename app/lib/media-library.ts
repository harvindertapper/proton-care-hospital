...
/* ───────────────────────────────────────────────────────────────────────────
   PUBLIC path validation and R2 URL generation (canonical from media-resolver.ts)
   ─────────────────────────────────────────────────────────────────────────── */

export type { PathValidationResult, UrlGenerationResult } from "./media-resolver.ts";
export { validatePublicPath, generateR2MediaUrl } from "./media-resolver.ts";
import { validatePublicPath, generateR2MediaUrl } from "./media-resolver.ts";
